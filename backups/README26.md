...
| <a name="55" href="#55">`55`</a>   [MCP-JS](https://github.com/hpssjellis/my-examples-of-mcp-js) |  My examples of running an MCP server client side completely in the browser the demo page is [here](https://hpssjellis.github.io/my-examples-of-mcp-js/public/index.html)  -  |  40%          |
