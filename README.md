...
| <a name="34" href="#34">`34`</a>   [google-coral-micro](https://github.com/hpssjellis/mcu-stable-edu-launch/tree/main/google-coral-micro) |    Google Coral Micro First look and installation on the Arduino and Linux (Ubuntu)     |       10%  This has been paused until Google makes a new updated version and supports it, as this one seems to have been deprecated [here](https://github.com/google-coral/coralmicro)        | 
