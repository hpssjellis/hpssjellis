...
| <a name="55" href="#55">`55`</a>   [MCP-JS](https://github.com/hpssjellis/my-examples-of-mcp-js) |  My examples of running an MCP server client side completely in the browser the demo page is [here](https://hpssjellis.github.io/my-examples-of-mcp-js/public/index.html)  -  |  20%          |
| <a name="54" href="#54">`54`</a>   [RAG-JS](https://hpssjellis.github.io/my-examples-of-transformersJS/public/deep-rag/deep-rag00.html) | Deep-RAG (Retrieval augmented generation) fully client-side RAG in the browser github part of my transformersJS work at [here](https://github.com/hpssjellis/my-examples-of-transformersJS/tree/main/public/deep-rag)   -  |  0%          | 
