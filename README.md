...
| <a name="9" href="#9">`9`</a>   [No link yet]() |     Use the Arduino Portenta to analyse sweat electrolytes and glucose        |       2%          | 
| <a name="11" href="#10">`10`</a>   [Adruino Portenta Stackable PCB making using easyEDA and JLCPCB](https://github.com/hpssjellis/maker100#31) |    The Arduino Portenta has 2x 80 pin HD connectors. This is a bit of a problem to make stackable boards unless you find out it is fairly easy using easyEDA and JLCPCB.       |       30%          | 
