...
| <a name="46" href="#46">`46`</a>   [maker100-curriculum](https://github.com/hpssjellis/maker100-curriculum) |    A hands on robotics, IoT, machine learning high school and undergrad curriculum designed for the students to solve the issues and to not need a specialist robotics instructor. The curriculum is not specific to a microcontroller and expects the purchase of a different microcontroller every few years. For the first year the educator will earn with the students, but the process of technology problem solving will always be the strength of this course.    |       80%          | 
